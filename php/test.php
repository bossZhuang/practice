...
$method = "POST";
$url_path = "/openapi/apollo_verify_openid_openkey";
$params = ["appid"=>"101523447","gameid"=>"4813","openid"=>"222","openkey"=>"1111","rnd"=>"1512981097","ts"=>"1543462808"];
$secret = "rivergameappkeys&";
$me = test::makeSig($method, $url_path, $params, $secret);
echo ($me."\n");
echo (urlencode($me)."\n");